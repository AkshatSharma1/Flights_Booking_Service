...
const { BOOKING_STATUS } = require("../utils/common/enums.js");
...
module.exports = (sequelize, DataTypes) => {
  ...
  Booking.init({
    ...
    status: {type: DataTypes.ENUM, values:[BOOKED, CANCELLED, INITIATED, PENDING],defaultValue: INITIATED, allowNull: false},
